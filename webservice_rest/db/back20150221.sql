...
ALTER TABLE ONLY public."User" DROP CONSTRAINT user_user_types;
ALTER TABLE ONLY public."Product" DROP CONSTRAINT product_category;
ALTER TABLE ONLY public."Order_Detail" DROP CONSTRAINT order_detail_product;
ALTER TABLE ONLY public."Order_Detail" DROP CONSTRAINT order_detail_order;
ALTER TABLE ONLY public."Kardex" DROP CONSTRAINT kardex_cellar;
ALTER TABLE ONLY public."Contact" DROP CONSTRAINT contact_user;
ALTER TABLE ONLY public."Contact" DROP CONSTRAINT contact_contact_type;
ALTER TABLE ONLY public."Cellar" DROP CONSTRAINT cellar_city;
ALTER TABLE ONLY public."Category" DROP CONSTRAINT category_category;
ALTER TABLE ONLY public."Temp_Cart" DROP CONSTRAINT "Temp_Cart_product_id_fkey";
ALTER TABLE ONLY public."Temp_Cart" DROP CONSTRAINT "TempCart_User";
ALTER TABLE ONLY public."Order" DROP CONSTRAINT "Order_user_id_fkey";
ALTER TABLE ONLY public."Order" DROP CONSTRAINT "Order_shipping_id_fkey";
ALTER TABLE ONLY public."Order" DROP CONSTRAINT "Order_billing_id_fkey";
ALTER TABLE ONLY public."User_Types" DROP CONSTRAINT user_types_pk;
ALTER TABLE ONLY public."User" DROP CONSTRAINT user_pk;
ALTER TABLE ONLY public."Product" DROP CONSTRAINT product_pk;
ALTER TABLE ONLY public."Permission" DROP CONSTRAINT permission_pk;
ALTER TABLE ONLY public."Order" DROP CONSTRAINT order_pk;
ALTER TABLE ONLY public."Order_Detail" DROP CONSTRAINT order_detail_pk;
ALTER TABLE ONLY public."Kardex" DROP CONSTRAINT kardex_pk;
ALTER TABLE ONLY public."Contact" DROP CONSTRAINT contact_pk;
ALTER TABLE ONLY public."Cellar" DROP CONSTRAINT cellar_pk;
ALTER TABLE ONLY public."Category" DROP CONSTRAINT category_pk;
ALTER TABLE ONLY public."Webpay" DROP CONSTRAINT "Webpay_pkey";
ALTER TABLE ONLY public."Voto" DROP CONSTRAINT "Votos_pkey";
ALTER TABLE ONLY public."Temp_Cart" DROP CONSTRAINT "Temp_Cart_pkey";
ALTER TABLE ONLY public."Tag" DROP CONSTRAINT "Tag_pkey";
ALTER TABLE ONLY public."Tag_Product" DROP CONSTRAINT "Tag_Product_pkey";
ALTER TABLE ONLY public."State" DROP CONSTRAINT "State_pkey";
ALTER TABLE ONLY public."Shipping" DROP CONSTRAINT "Shipping_pkey";
ALTER TABLE ONLY public."Shipping_Provider" DROP CONSTRAINT "Shipping_Provider_pkey";
ALTER TABLE ONLY public."Shipping_Provider" DROP CONSTRAINT "Shipping_Provider_name_key";
...
ALTER TABLE ONLY public."Access_Token" DROP CONSTRAINT "Access_Token_pkey";
ALTER TABLE public."Webpay" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Voto" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."User_Types" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."User" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Temp_Cart" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Tag_Product" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Tag" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."State" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Shipping_Provider" ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public."Cellar" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Category" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Brand" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Access_Token" ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE public."Webpay_id_seq";
DROP TABLE public."Webpay";
DROP SEQUENCE public."Votos_id_seq";
DROP TABLE public."Voto";
DROP SEQUENCE public."User_id_seq";
DROP SEQUENCE public."User_Types_id_seq";
DROP TABLE public."User_Types";
DROP TABLE public."User";
DROP SEQUENCE public."Temp_Cart_id_seq";
DROP TABLE public."Temp_Cart";
DROP SEQUENCE public."Tag_name_seq";
DROP SEQUENCE public."Tag_id_seq";
DROP SEQUENCE public."Tag_Product_id_seq";
DROP TABLE public."Tag_Product";
DROP TABLE public."Tag";
DROP SEQUENCE public."State_id_seq";
DROP TABLE public."State";
DROP SEQUENCE public."Shipping_id_seq";
DROP SEQUENCE public."Shipping_Provider_id_seq";
DROP TABLE public."Shipping_Provider";
DROP TABLE public."Shipping";
DROP SEQUENCE public."Product_id_seq";
DROP TABLE public."Product";
DROP SEQUENCE public."Permission_id_seq";
DROP TABLE public."Permission";
DROP SEQUENCE public."Payment_Types_name_seq";
...
DROP SEQUENCE public."Cellar_id_seq";
...
SELECT pg_catalog.setval('"Access_Token_id_seq"', 12780, true);
...
INSERT INTO "City" VALUES (9, 'Concepción');
...
INSERT INTO "City" VALUES (15, 'Copiapó');
INSERT INTO "City" VALUES (16, 'Valparaíso');
INSERT INTO "City" VALUES (19, 'Tarapacá');
INSERT INTO "City" VALUES (20, 'Chillán');
INSERT INTO "City" VALUES (21, 'Curicó');
INSERT INTO "City" VALUES (22, '');
INSERT INTO "City" VALUES (23, 'Arica DHSS');
INSERT INTO "City" VALUES (24, 'Arica DHS');
INSERT INTO "City" VALUES (25, 'Antofagasta Día Hábil Siguiente');
INSERT INTO "City" VALUES (26, 'Antofagasta Día Hábil Sub Siguiente');
INSERT INTO "City" VALUES (27, 'Arica Día Hábil Siguente');
INSERT INTO "City" VALUES (28, 'Arica Día Hábil Sub Siguiente');
...
INSERT INTO "City" VALUES (33, 'Viña del Mar');
...
INSERT INTO "Contact" VALUES (58, 'Yi Chun', 'yichun212@gmail.com', 'alonso de córdova 5870', '97855603', 3, '984152515', '', 'Lin', 15, 'santiago', '', '14.645.855-6', 5);
...
INSERT INTO "Contact" VALUES (32, 'jose', 'jarenasmuller@gmail.com', 'av. americo vespucio', '8251951', 3, '8251951', '', 'Arenas Müller', 22, 'la florida', '', '16323861-6', NULL);
...
INSERT INTO "Kardex" VALUES (2240, 'GDF-OI14-Queltehue-C16', 1, 33558, 69900, 5, 33558, 1, 33558, 33558, '2015-02-20 23:35:55.451095', 'yichun212@gmail.com', 'mov_out', '', '35.0');
INSERT INTO "Kardex" VALUES (2241, 'GDF-OI14-Queltehue-C16', 1, 33558, 0, 12, 33558, 1, 33558, 33558, '2015-02-20 23:35:55.451095', 'yichun212@gmail.com', 'mov_in', '', '35.0');
INSERT INTO "Kardex" VALUES (2242, 'GDF-OI14-Queltehue-C16', 1, 33558, 69900, 12, 33558, 0, 0, 0, '2015-02-20 23:39:40.762069', 'Sistema', 'sell', 'beige taupe', '35.0');
INSERT INTO "Kardex" VALUES (2085, 'GDF-OI14-Queltehue-C35', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:15.94864', 'ricardo@loadingplay.com', 'buy', 'azul café', '35.0');
INSERT INTO "Kardex" VALUES (2086, 'GDF-OI14-Queltehue-C35', 4, 33558, 0, 5, 134232, 4, 33558, 134232, '2015-01-26 22:52:16.05246', 'ricardo@loadingplay.com', 'buy', 'azul café', '36.0');
INSERT INTO "Kardex" VALUES (2087, 'GDF-OI14-Queltehue-C35', 12, 33558, 0, 5, 402696, 12, 33558, 402696, '2015-01-26 22:52:16.154327', 'ricardo@loadingplay.com', 'buy', 'azul café', '37.0');
INSERT INTO "Kardex" VALUES (2088, 'GDF-OI14-Queltehue-C35', 6, 33558, 0, 5, 201348, 6, 33558, 201348, '2015-01-26 22:52:16.25884', 'ricardo@loadingplay.com', 'buy', 'azul café', '38.0');
INSERT INTO "Kardex" VALUES (2089, 'GDF-OI14-Queltehue-C35', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:16.366565', 'ricardo@loadingplay.com', 'buy', 'azul café', '39.0');
INSERT INTO "Kardex" VALUES (2090, 'GDF-OI14-Queltehue-C35', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:16.47299', 'ricardo@loadingplay.com', 'buy', 'azul café', '40.0');
INSERT INTO "Kardex" VALUES (2091, 'GDF-OI14-Queltehue-C19', 3, 33558, 0, 5, 100674, 3, 33558, 100674, '2015-01-26 22:52:17.119818', 'ricardo@loadingplay.com', 'buy', 'café moro', '35.0');
INSERT INTO "Kardex" VALUES (2092, 'GDF-OI14-Queltehue-C19', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:17.222992', 'ricardo@loadingplay.com', 'buy', 'café moro', '37.0');
INSERT INTO "Kardex" VALUES (2093, 'GDF-OI14-Queltehue-C19', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:17.334229', 'ricardo@loadingplay.com', 'buy', 'café moro', '39.0');
INSERT INTO "Kardex" VALUES (2094, 'GDF-OI14-Queltehue-C38', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:17.983549', 'ricardo@loadingplay.com', 'buy', 'café ocre', '36.0');
INSERT INTO "Kardex" VALUES (2095, 'GDF-OI14-Queltehue-C38', 3, 33558, 0, 5, 100674, 3, 33558, 100674, '2015-01-26 22:52:18.083438', 'ricardo@loadingplay.com', 'buy', 'café ocre', '37.0');
INSERT INTO "Kardex" VALUES (2096, 'GDF-OI14-Queltehue-C38', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:18.186152', 'ricardo@loadingplay.com', 'buy', 'café ocre', '38.0');
INSERT INTO "Kardex" VALUES (2097, 'GDF-OI14-Queltehue-C38', 3, 33558, 0, 5, 100674, 3, 33558, 100674, '2015-01-26 22:52:18.299221', 'ricardo@loadingplay.com', 'buy', 'café ocre', '39.0');
INSERT INTO "Kardex" VALUES (2098, 'GDF-OI14-Queltehue-C38', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:18.421645', 'ricardo@loadingplay.com', 'buy', 'café ocre', '40.0');
...
INSERT INTO "Kardex" VALUES (2108, 'GDF-OI14-Queltehue-C33', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:21.717564', 'ricardo@loadingplay.com', 'buy', 'café beige', '35.0');
INSERT INTO "Kardex" VALUES (2109, 'GDF-OI14-Queltehue-C33', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:21.83047', 'ricardo@loadingplay.com', 'buy', 'café beige', '40.0');
INSERT INTO "Kardex" VALUES (2110, 'GDF-OI14-Queltehue-C26', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:22.515703', 'ricardo@loadingplay.com', 'buy', 'camel café', '35.0');
INSERT INTO "Kardex" VALUES (2111, 'GDF-OI14-Queltehue-C26', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:22.621056', 'ricardo@loadingplay.com', 'buy', 'camel café', '37.0');
INSERT INTO "Kardex" VALUES (2112, 'GDF-OI14-Gavilan-C13', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:23.308609', 'ricardo@loadingplay.com', 'buy', 'café beige', '35.0');
INSERT INTO "Kardex" VALUES (2113, 'GDF-OI14-Gavilan-C13', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:23.413929', 'ricardo@loadingplay.com', 'buy', 'café beige', '36.0');
INSERT INTO "Kardex" VALUES (2114, 'GDF-OI14-Gavilan-C13', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:23.521', 'ricardo@loadingplay.com', 'buy', 'café beige', '37.0');
INSERT INTO "Kardex" VALUES (2115, 'GDF-OI14-Gavilan-C13', 3, 33558, 0, 5, 100674, 3, 33558, 100674, '2015-01-26 22:52:23.626171', 'ricardo@loadingplay.com', 'buy', 'café beige', '38.0');
INSERT INTO "Kardex" VALUES (2116, 'GDF-OI14-Gavilan-C13', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:23.73097', 'ricardo@loadingplay.com', 'buy', 'café beige', '39.0');
INSERT INTO "Kardex" VALUES (2117, 'GDF-OI14-Gavilan-C13', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:23.858055', 'ricardo@loadingplay.com', 'buy', 'café beige', '40.0');
INSERT INTO "Kardex" VALUES (2118, 'GDF-OI14-Gavilan-C11', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:24.585898', 'ricardo@loadingplay.com', 'buy', 'café beige', '39.0');
INSERT INTO "Kardex" VALUES (2119, 'GDF-OI14-Gavilan-C11', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:24.692382', 'ricardo@loadingplay.com', 'buy', 'café beige', '40.0');
INSERT INTO "Kardex" VALUES (2120, 'GDF-OI14-Gavilan-C10', 2, 33558, 0, 5, 67116, 2, 33558, 67116, '2015-01-26 22:52:25.415447', 'ricardo@loadingplay.com', 'buy', 'café gris', '37.0');
INSERT INTO "Kardex" VALUES (2121, 'GDF-OI14-Gavilan-C10', 3, 33558, 0, 5, 100674, 3, 33558, 100674, '2015-01-26 22:52:25.523429', 'ricardo@loadingplay.com', 'buy', 'café gris', '38.0');
INSERT INTO "Kardex" VALUES (2122, 'GDF-OI14-Gavilan-C10', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:25.625407', 'ricardo@loadingplay.com', 'buy', 'café gris', '39.0');
INSERT INTO "Kardex" VALUES (2123, 'GDF-OI14-Gavilan-C10', 1, 33558, 0, 5, 33558, 1, 33558, 33558, '2015-01-26 22:52:25.727822', 'ricardo@loadingplay.com', 'buy', 'café gris', '40.0');
...
INSERT INTO "Kardex" VALUES (2130, 'GDF-OI14-Gavilan-C6', 4, 33558, 0, 5, 134232, 4, 33558, 134232, '2015-01-26 22:52:27.659893', 'ricardo@loadingplay.com', 'buy', 'café', '37.0');
...
INSERT INTO "Kardex" VALUES (2151, 'GDF-PV14-Kereu-C11', 2, 34391, 0, 5, 68782, 2, 34391, 68782, '2015-01-26 22:52:35.464931', 'ricardo@loadingplay.com', 'buy', 'café', '38.0');
INSERT INTO "Kardex" VALUES (2152, 'GDF-PV14-Kereu-C11', 2, 34391, 0, 5, 68782, 2, 34391, 68782, '2015-01-26 22:52:35.564923', 'ricardo@loadingplay.com', 'buy', 'café', '40.0');
...
INSERT INTO "Kardex" VALUES (2156, 'GDF-PV14-Kereu-C5', 1, 34391, 0, 5, 34391, 1, 34391, 34391, '2015-01-26 22:52:37.248778', 'ricardo@loadingplay.com', 'buy', 'café verde', '35.0');
INSERT INTO "Kardex" VALUES (2157, 'GDF-PV14-Kereu-C5', 1, 34391, 0, 5, 34391, 1, 34391, 34391, '2015-01-26 22:52:37.358286', 'ricardo@loadingplay.com', 'buy', 'café verde', '37.0');
INSERT INTO "Kardex" VALUES (2158, 'GDF-PV14-Kereu-C5', 2, 34391, 0, 5, 68782, 2, 34391, 68782, '2015-01-26 22:52:37.549534', 'ricardo@loadingplay.com', 'buy', 'café verde', '38.0');
INSERT INTO "Kardex" VALUES (2159, 'GDF-PV14-Kereu-C5', 1, 34391, 0, 5, 34391, 1, 34391, 34391, '2015-01-26 22:52:37.652283', 'ricardo@loadingplay.com', 'buy', 'café verde', '39.0');
...
INSERT INTO "Kardex" VALUES (2162, 'GDF-PV14-Kereu-C3', 1, 34391, 0, 5, 34391, 1, 34391, 34391, '2015-01-26 22:52:39.282159', 'ricardo@loadingplay.com', 'buy', 'café negro', '35.0');
INSERT INTO "Kardex" VALUES (2163, 'GDF-PV14-Kereu-C3', 1, 34391, 0, 5, 34391, 1, 34391, 34391, '2015-01-26 22:52:39.386481', 'ricardo@loadingplay.com', 'buy', 'café negro', '36.0');
...
SELECT pg_catalog.setval('"Kardex_id_seq"', 2242, true);
...
INSERT INTO "Order" VALUES (281, '2015-02-20 23:35:55.290998', 1, 69900, 0, 0, 69900, 1, 1, 733, 69, 69, 1, 'web', '', 4, 'codigodespacho', 2);
...
INSERT INTO "Order_Detail" VALUES (322, 1, 69900, 281, 116, '35.0');
...
SELECT pg_catalog.setval('"Order_Detail_id_seq"', 322, true);
...
SELECT pg_catalog.setval('"Order_id_seq"', 281, true);
...
INSERT INTO "Product" VALUES (116, 'GDF-OI14-Queltehue-C16', '<ul><li>Color: beige taupe&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C16.png', '1_GDF-OI14-Queltehue-C16.png', '2_GDF-OI14-Queltehue-C16.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C16', 'beige taupe', '.', 69900, '', '', 1, '3_GDF-OI14-Queltehue-C16.png', '4_GDF-OI14-Queltehue-C16.png', '5_GDF-OI14-Queltehue-C16.png');
INSERT INTO "Product" VALUES (113, 'GDF-OI14-Queltehue-C35', '<ul><li>Color: azul café&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,36.0,37.0,38.0,39.0,40.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C35.png', '1_GDF-OI14-Queltehue-C35.png', '2_GDF-OI14-Queltehue-C35.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C35', 'azul café', '.', 69900, '', '', 1, '3_GDF-OI14-Queltehue-C35.png', '4_GDF-OI14-Queltehue-C35.png', '5_GDF-OI14-Queltehue-C35.png');
INSERT INTO "Product" VALUES (114, 'GDF-OI14-Queltehue-C19', '<ul><li>Color: café moro&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,37.0,39.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C19.png', '1_GDF-OI14-Queltehue-C19.png', '2_GDF-OI14-Queltehue-C19.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C19', 'café moro', '.', 69900, '', '', 1, '3_GDF-OI14-Queltehue-C19.png', '4_GDF-OI14-Queltehue-C19.png', '5_GDF-OI14-Queltehue-C19.png');
INSERT INTO "Product" VALUES (118, 'GDF-OI14-Queltehue-C30', '<ul><li>Color: camel azul&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,36.0,37.0,38.0,39.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C30.png', '1_GDF-OI14-Queltehue-C30.png', '2_GDF-OI14-Queltehue-C30.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C30', 'camel azul', '.', 69900, '', '', 1, '3_GDF-OI14-Queltehue-C30.png', '4_GDF-OI14-Queltehue-C30.png', '5_GDF-OI14-Queltehue-C30.png');
INSERT INTO "Product" VALUES (115, 'GDF-OI14-Queltehue-C38', '<ul><li>Color: café ocre&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{36.0,37.0,38.0,39.0,40.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C38.png', '1_GDF-OI14-Queltehue-C38.png', '2_GDF-OI14-Queltehue-C38.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C38', 'café ocre', '.', 69900, '', '', 1, '3_GDF-OI14-Queltehue-C38.png', '4_GDF-OI14-Queltehue-C38.png', '5_GDF-OI14-Queltehue-C38.png');
INSERT INTO "Product" VALUES (117, 'GDF-OI14-Queltehue-C39', '<ul><li>Color: negro camel&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{37.0,38.0,39.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C39.png', '1_GDF-OI14-Queltehue-C39.png', '2_GDF-OI14-Queltehue-C39.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C39', 'negro camel', '.', 1, '', '', 1, '3_GDF-OI14-Queltehue-C39.png', '4_GDF-OI14-Queltehue-C39.png', '5_GDF-OI14-Queltehue-C39.png');
...
INSERT INTO "Product" VALUES (121, 'GDF-OI14-Gavilan-C13', '<ul><li>Color: Café Beige</li><li>Capellada (material exterior): Cuero</li><li>Forro (material interior): Cuero</li><li>Plantilla: Cuero</li><li>Planta: (suela) Goma</li><li>Taco: Goma</li><li>Altura del Taco: 4,5 cm</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,36.0,37.0,38.0,39.0,40.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Gavilan-C13.png', '1_GDF-OI14-Gavilan-C13.png', '2_GDF-OI14-Gavilan-C13.png', 33558, 1, '', 'Calzur Ltda.', 'Gavilan C13', 'café beige', '.', 69900, '', '', 1, '3_GDF-OI14-Gavilan-C13.png', '4_GDF-OI14-Gavilan-C13.png', '5_GDF-OI14-Gavilan-C13.png');
INSERT INTO "Product" VALUES (127, 'GDF-OI14-Gavilan-C5', '<ul><li>Color: verde gris&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{37.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Gavilan-C5.png', '1_GDF-OI14-Gavilan-C5.png', '2_GDF-OI14-Gavilan-C5.png', 33558, 1, '', 'Calzur Ltda.', 'Gavilan C5', 'verde gris', '.', 69900, '', '', 1, '3_GDF-OI14-Gavilan-C5.png', '4_GDF-OI14-Gavilan-C5.png', '5_GDF-OI14-Gavilan-C5.png');
INSERT INTO "Product" VALUES (120, 'GDF-OI14-Queltehue-C26', '<ul><li>Color: camel café&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,37.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C26.png', '1_GDF-OI14-Queltehue-C26.png', '2_GDF-OI14-Queltehue-C26.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C26', 'camel café', '.', 69900, '', '', 1, '3_GDF-OI14-Queltehue-C26.png', '4_GDF-OI14-Queltehue-C26.png', '5_GDF-OI14-Queltehue-C26.png');
INSERT INTO "Product" VALUES (119, 'GDF-OI14-Queltehue-C33', '<ul><li>Color: café beige&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,40.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Queltehue-C33.png', '1_GDF-OI14-Queltehue-C33.png', '2_GDF-OI14-Queltehue-C33.png', 33558, 1, '', 'Calzur Ltda.', 'Queltehue C33', 'café beige', '.', 69900, '', '', 1, '3_GDF-OI14-Queltehue-C33.png', '4_GDF-OI14-Queltehue-C33.png', '5_GDF-OI14-Queltehue-C33.png');
...
INSERT INTO "Product" VALUES (131, 'GDF-PV14-Lile-C1', '<ul><li>Color: Camel&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 6 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{37.0}', '', '', '', NULL, NULL, '0_GDF-PV14-Lile-C1.png', '1_GDF-PV14-Lile-C1.png', '2_GDF-PV14-Lile-C1.png', 34510, 1, '', 'Calzur Ltda.', 'Lile C1', 'camel', '.', 69900, '', '', 1, '3_GDF-PV14-Lile-C1.png', '4_GDF-PV14-Lile-C1.png', '5_GDF-PV14-Lile-C1.png');
INSERT INTO "Product" VALUES (139, 'GDF-PV14-Lile-C13', '<ul><li>Color: beige&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 6 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,37.0}', '', '', '', NULL, NULL, '0_GDF-PV14-Lile-C13.png', '1_GDF-PV14-Lile-C13.png', '2_GDF-PV14-Lile-C13.png', 34510, 1, '', 'Calzur Ltda.', 'Lile C13', 'Beige', '.', 69900, '', '', 1, '3_GDF-PV14-Lile-C13.png', '4_GDF-PV14-Lile-C13.png', '5_GDF-PV14-Lile-C13.png');
...
INSERT INTO "Product" VALUES (125, 'GDF-OI14-Gavilan-C6', '<ul><li>Color: café&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{37.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Gavilan-C6.png', '1_GDF-OI14-Gavilan-C6.png', '2_GDF-OI14-Gavilan-C6.png', 33558, 1, '', 'Calzur Ltda.', 'Gavilan C6', 'café', '.', 69900, '', '', 1, '3_GDF-OI14-Gavilan-C6.png', '4_GDF-OI14-Gavilan-C6.png', '5_GDF-OI14-Gavilan-C6.png');
...
INSERT INTO "Product" VALUES (124, 'GDF-OI14-Gavilan-C12', '<ul><li>Color: verde beige&nbsp;</li><li>Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,36.0,37.0,38.0,39.0,40.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Gavilan-C12.png', '1_GDF-OI14-Gavilan-C12.png', '2_GDF-OI14-Gavilan-C12.png', 33558, 1, '', 'Calzur Ltda.', 'Gavilan C12', 'verde beige', '.', 69900, '', '', 1, '3_GDF-OI14-Gavilan-C12.png', '4_GDF-OI14-Gavilan-C12.png', '5_GDF-OI14-Gavilan-C12.png');
...
INSERT INTO "Product" VALUES (123, 'GDF-OI14-Gavilan-C10', '<ul><li>Color: café gris&nbsp;<br></li><li>Capellada (material exterior): Cuero&nbsp;<br></li><li>Forro (material interior): Cuero&nbsp;<br></li><li>Plantilla: Cuero&nbsp;<br></li><li>Planta (suela): Goma&nbsp;<br></li><li>Taco: Goma&nbsp;<br></li><li>Altura del Taco: 4,5 cm&nbsp;<br></li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{37.0,38.0,39.0,40.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Gavilan-C10.png', '1_GDF-OI14-Gavilan-C10.png', '2_GDF-OI14-Gavilan-C10.png', 33558, 1, '', 'Calzur Ltda.', 'Gavilan C10', 'café gris', '.', 69900, '', '', 1, '3_GDF-OI14-Gavilan-C10.png', '4_GDF-OI14-Gavilan-C10.png', '5_GDF-OI14-Gavilan-C10.png');
INSERT INTO "Product" VALUES (126, 'GDF-OI14-Gavilan-C2', '<ul><li>Color: negro&nbsp;</li><li>&nbsp;Capellada (material exterior): Cuero&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 4,5 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,40.0}', '', '', '', NULL, NULL, '0_GDF-OI14-Gavilan-C2.png', '1_GDF-OI14-Gavilan-C2.png', '2_GDF-OI14-Gavilan-C2.png', 33558, 1, '', 'Calzur Ltda.', 'Gavilan C2', 'negro', '.', 69900, '', '', 1, '3_GDF-OI14-Gavilan-C2.png', '4_GDF-OI14-Gavilan-C2.png', '5_GDF-OI14-Gavilan-C2.png');
INSERT INTO "Product" VALUES (136, 'GDF-PV14-Kereu-C5', '<ul><li>Color: café verde&nbsp;</li><li>Capellada (material exterior): Reno&nbsp;</li><li>Forro (material interior): Cuero&nbsp;</li><li>Plantilla: Cuero&nbsp;</li><li>Planta (suela): Goma&nbsp;</li><li>Taco: Goma&nbsp;</li><li>Altura del Taco: 6 cm&nbsp;</li><li>Estilo: Botín<br></li></ul>', 'Giani Da Firenze', '{35.0,37.0,38.0,39.0}', '', '', '', NULL, NULL, '0_GDF-PV14-Kereu-C5.png', '1_GDF-PV14-Kereu-C5.png', '2_GDF-PV14-Kereu-C5.png', 34391, 1, '', 'Calzur Ltda.', 'Kereu C5', 'café verde', '.', 69900, '', '', 1, '3_GDF-PV14-Kereu-C5.png', '4_GDF-PV14-Kereu-C5.png', '5_GDF-PV14-Kereu-C5.png');
...
INSERT INTO "Shipping" VALUES (11, 3, 25, 0, 6690, 6690, false, 1);
INSERT INTO "Shipping" VALUES (12, 3, 26, 0, 4010, 4010, false, 1);
INSERT INTO "Shipping" VALUES (9, 3, 28, 0, 4480, 4480, true, 1);
INSERT INTO "Shipping" VALUES (10, 3, 27, 0, 7420, 7420, true, 1);
INSERT INTO "Shipping" VALUES (13, 3, 29, 0, 3890, 3890, false, 1);
INSERT INTO "Shipping" VALUES (14, 3, 12, 0, 3890, 3890, false, 1);
INSERT INTO "Shipping" VALUES (15, 3, 14, 0, 3890, 3890, false, 1);
INSERT INTO "Shipping" VALUES (16, 3, 30, 0, 3890, 3890, false, 1);
INSERT INTO "Shipping" VALUES (17, 3, 31, 0, 3720, 3720, false, 1);
INSERT INTO "Shipping" VALUES (18, 3, 33, 0, 3720, 3720, false, 1);
INSERT INTO "Shipping" VALUES (19, 3, 32, 0, 3720, 3720, true, 1);
INSERT INTO "Shipping" VALUES (21, 3, 13, 0, 3780, 3780, false, 1);
INSERT INTO "Shipping" VALUES (22, 3, 34, 0, 3780, 3780, false, 1);
INSERT INTO "Shipping" VALUES (23, 3, 21, 0, 3780, 3780, false, 1);
INSERT INTO "Shipping" VALUES (24, 3, 6, 0, 3780, 3780, false, 1);
INSERT INTO "Shipping" VALUES (25, 3, 20, 0, 3780, 3780, false, 1);
INSERT INTO "Shipping" VALUES (26, 3, 9, 0, 3780, 3780, false, 1);
INSERT INTO "Shipping" VALUES (27, 3, 35, 0, 3780, 3780, false, 1);
INSERT INTO "Shipping" VALUES (28, 3, 10, 0, 3900, 3900, false, 1);
INSERT INTO "Shipping" VALUES (29, 3, 4, 0, 3900, 3900, false, 1);
INSERT INTO "Shipping" VALUES (30, 3, 36, 0, 3900, 3900, true, 1);
INSERT INTO "Shipping" VALUES (32, 3, 37, 0, 4250, 4250, false, 1);
INSERT INTO "Shipping" VALUES (33, 3, 38, 0, 7130, 7130, false, 1);
INSERT INTO "Shipping" VALUES (34, 3, 11, 0, 7130, 7130, false, 1);
INSERT INTO "Shipping" VALUES (20, 3, 3, 0, 2450, 0, true, 1);
...
INSERT INTO "Temp_Cart" VALUES (471, 115, '2015-02-21 04:30:28.599145', 1, 69900, 16, '36.0', NULL, NULL, NULL, 1, 0);
INSERT INTO "Temp_Cart" VALUES (472, 116, '2015-02-21 04:50:19.794448', 1, 69900, 746, '35.0', NULL, NULL, NULL, 1, 0);
INSERT INTO "Temp_Cart" VALUES (473, 113, '2015-02-21 04:51:08.633833', 1, 69900, 733, '35.0', NULL, NULL, NULL, 1, 0);
INSERT INTO "Temp_Cart" VALUES (474, 113, '2015-02-21 04:51:54.804337', 1, 69900, 745, '35.0', NULL, NULL, NULL, 1, 0);
...
SELECT pg_catalog.setval('"Temp_Cart_id_seq"', 474, true);
...
INSERT INTO "User" VALUES (792, '{}', 5, '', '', 'd41d8cd98f00b204e9800998ecf8427e', '{}', '', '', '', NULL, '2015-02-20 22:56:25.030665', 1, '2015-02-20 22:56:25.030665', '2015-02-20 22:56:25.030665', 0);
...
INSERT INTO "User" VALUES (250, '{1,2,3,4,5,6}', 1, 'Miguel Angel', 'masg@gianidafirenze.cl', '81dc9bdb52d04dc20036dbd8313ed055', '{5,12}', 'Soto', '', '', NULL, '2014-09-22 03:21:21.901746', 1, '2014-09-22 03:21:21.901746', '2014-09-22 03:21:21.901746', 0);
...
SELECT pg_catalog.setval('"User_id_seq"', 792, true);
